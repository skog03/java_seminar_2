...
public class MainService {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(
					"Weighted Avg: " + st3.getName() + " " + st3.getSurname() + " -> " + wheightedAVGgrade(st3));
			System.out.println(
					"Weighted Avg: " + st2.getName() + " " + st2.getSurname() + " -> " + wheightedAVGgrade(st2));
			System.out.println(
					"Weighted Avg: " + st4.getName() + " " + st4.getSurname() + " -> " + wheightedAVGgrade(st4));
			...
			System.out.println("Courses taught by : " + pr4.getName() + " " + pr4.getSurname() + " -> "
					+ coursesPerProfessor(pr4));
			System.out.println("Courses taught by : " + pr3.getName() + " " + pr3.getSurname() + " -> "
					+ coursesPerProfessor(pr3));
			System.out.println("Courses taught by : " + pr2.getName() + " " + pr2.getSurname() + " -> "
					+ coursesPerProfessor(pr2));
	...
	// calculates average grade based on course credit points (weighted average
	...
	public static void sortStudentsByAVG() throws Exception {
		...
		for (int i = 0; i < allPerson.size(); i++) {
			for (int j = 0; j < allPerson.size(); j++) {
				...
				if (allPerson.get(i) instanceof Student && allPerson.get(j) instanceof Student) {

					Student tempI = (Student) allPerson.get(i);
					Student tempJ = (Student) allPerson.get(j);
	...
	public static void updateStudentByPersonCode(String name, String surname, String inputPersonCode) throws Exception {
		if (name == null || surname == null || inputPersonCode == null)
			throw new Exception("Wrong input");
